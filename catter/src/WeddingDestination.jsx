  ...
  return (
    <section className="flex justify-between flex-row gap-8 max-md:flex-col p-5 mt-7">
      ...
      <div className="w-1/2 max-md:w-full p-5">
        <h1 className="text-2xl font-bold text-rose-800 tracking-widest uppercase">
          Wedding Destination.
        </h1>
        <h2 className="text-3xl font-bold text-[#222222] tracking-widest uppercase py-5">
          Story
        </h2>
        <p className="text-xl text-start text-[#222222]">
          Planning a dreamy destination wedding? Let us help with smart tips and
          services for a smooth, stress-free celebration! 🌍💍
        </p>
        <p className="text-xl text-start mb-5 text-[#222222] py-2">
        ...
        <button
          type="button"
          className="font-sans cursor-pointer flex mt-2 py-4 px-7 justify-center gap-2 items-center mx-auto shadow-xl text-xl text-gray-50 bg-rose-800 backdrop-blur-md lg:font-semibold relative z-10 overflow-hidden border-2 rounded-full transition-all duration-300 hover:bg-rose-700"
        >
          Read More
        </button>
      </div>
